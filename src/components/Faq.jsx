...
const Faq = () => {
    const faq = [
        ...
        {
            title: "Why Ethereum?",
            body: `Ethereum uses a Proof-Of-Work approach, meaning all the transactions get recorded internally on the Ethereum blockchain. This makes the transactions much more secure. `,
        },
        {
        ...
        },
        {
            ...
            body: `Our mission is to launch DAO, early investors would have an opportunity to be involved in building
