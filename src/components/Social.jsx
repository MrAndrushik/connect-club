            ...
            <div className="social__container container">
                ...
                <div className="social__wrapper">
                    <div className="social__column social__column--1">
                        <p className="social__vertical social__subtitle">
                            Join the Community
                        </p>
                        <div className="social__content">
                            <p className="social__text stn-text">
                                Want to learn more? Have questions? Jump into
                                our community!
                            </p>
                            <a
                                target="_blank"
                    ...
                    <div className="social__column social__column--2">
                        <div className="social__content">
                            <p className="social__subtitle social__subtitle--app">
                                Download Connect.Club app:
                            </p>
                            <a
                                target="_blank"
                                rel="noreferrer"
